...
table |> 
    ggplot(aes(x = rowname, y = V1, fill = `Quelle est votre catégorie d'emploi actuel ?`, group = `Quelle est votre catégorie d'emploi actuel ?`)) +
      ...
      coord_flip() +
      labs(x = "", y = "Nombre de réponses", title = "Répartition des besoins de formation des individus selon leur type d'activités dédiées aux données",
           subtitle = paste(sum(table$V1), "réponses")) +
      scale_x_discrete(labels = function(x) stringr::str_wrap(x, width = 40)) + 
      theme_classic() +
      theme(legend.position = "none",
...
table |> 
    ggplot(aes(x = rowname, y = V1, fill = `Quelle est votre catégorie d'emploi actuel ?`, group = `Quelle est votre catégorie d'emploi actuel ?`)) +
      ...
      labs(x = "", y = "Nombre de réponses", title = "Répartition des besoins de formation des individus selon \nleur type d'activités dédiées aux données",
           subtitle = paste(sum(table$V1), "réponses")) +
      scale_x_discrete(labels = function(x) stringr::str_wrap(x, width = 40)) + 
      theme_classic() +
      theme(legend.position = "bottom",
...
table |> 
    ...
    ggplot(aes(x = rowname, y = V1, fill = `Quelle est votre catégorie d'emploi actuel ?`, group = `Quelle est votre catégorie d'emploi actuel ?`)) +
      ...
      theme_classic() +
      theme(legend.position = "none",
            text = element_text(family = "Monsterrat", size = 12, hjust = 1),
            plot.title = element_text(face = "bold", hjust = 1), 
            axis.title.y = element_blank(),
            axis.line.x = element_blank(),
            axis.line.y = element_blank(),
