    ...
    ggplot(aes(y = V1)) + 
     #text = paste("Besoin de formation :", formation, "\nTravail des données :", rowname, "\n", V1, "réponses soit", percent, "%"))) +
      ...
      labs(x = "Besoins de formation", y = "Nombre de réponses", 
           title = "Besoins de formation des individus selon leur type d'activités du travail des données",
...
table |> 
    ...
    ggplot(aes(x = rowname, y = V1, fill = `Quelle est votre catégorie d'emploi actuel ?`, group = `Quelle est votre catégorie d'emploi actuel ?`)) +
      ...
      labs(x = "", y = "Nombre de réponses", 
           title = "Répartition de chaque type d'activité des données selon la catégorie d'emploi",
...
croisements_domaine(96, 110, 6) |> 
    ...
    ggplot(aes(y = V1)) + 
      ...
      labs(x = "Domaine thématique", y = "Nombre de réponses", 
           title = "Répartition des besoins de formation par domaine thématique des répondants",
...
croisements_domaine(81, 84, 4) |> 
    ...
    ggplot(aes(y = V1)) + 
      geom_col(aes(x = domaine), color = "white", fill = "#5770BE", width = 0.7) +
      labs(x = "Domaine thématique", y = "Nombre de réponses", 
           title = "Répartition des types de formation en gestion de données par domaine thématique des répondants",
           subtitle = paste0(sum(formation_activites$V1), " réponses")) +
      theme_classic() +
      scale_x_discrete(labels = function(x) stringr::str_wrap(x, width = 50)) + #axis-text trop longs sur plusieurs lignes
      coord_flip() +
...
croisements_domaine(16, 22, 7) |> 
    ...
    ggplot(aes(y = V1)) + 
      geom_col(aes(x = domaine), color = "white", fill = "#5770BE", width = 0.7) +
      labs(x = "Domaine thématique", y = "Nombre de réponses", 
           title = "Répartition de l'intervention dans le cycle de vie de la donnée par domaine thématique des répondants",
           subtitle = paste0(sum(formation_activites$V1), " réponses")) +
      theme_classic() +
      scale_x_discrete(labels = function(x) stringr::str_wrap(x, width = 50)) + #axis-text trop longs sur plusieurs lignes
      coord_flip() +
...
croisements_domaine(23, 37, 6) |> 
    ...
    ggplot(aes(y = V1)) + 
      geom_col(aes(x = domaine), color = "white", fill = "#5770BE", width = 0.7) +
      labs(x = "Domaine thématique", y = "Nombre de réponses",
           title = "Répartition du type d'activité dans les données par domaine thématique des répondants",
           caption = "Top 6 des catégories les plus représentées",
           subtitle = paste0(sum(formation_activites$V1), " réponses")) +
      theme_classic() +
      scale_x_discrete(labels = function(x) stringr::str_wrap(x, width = 50)) + #axis-text trop longs sur plusieurs lignes
...
croisements_domaine(66, 76, 6) |> 
    ...
    ggplot(aes(y = V1)) + 
      geom_col(aes(x = domaine), color = "white", fill = "#5770BE", width = 0.7) +
      labs(x = "Domaine thématique", y = "Nombre de réponses", 
           title = "Répartition du type de données travaillé par domaine thématique des répondants",
           caption = "Top 6 des catégories les plus représentées",
           subtitle = paste0(sum(formation_activites$V1), " réponses")) +
      theme_classic() +
      scale_x_discrete(labels = function(x) stringr::str_wrap(x, width = 50)) + #axis-text trop longs sur plusieurs lignes
...
table |> 
    ...
    mutate(rowname = fct_reorder(rowname, V1),
           `Dans quel type d'établissement exercez-vous votre activité ?` = 
               factor(`Dans quel type d'établissement exercez-vous votre activité ?`, 
                      levels = c("Organisme de recherche","Université","Ecole","Autre"))) |> 
    ggplot(aes(x = rowname, y = V1, fill = `Dans quel type d'établissement exercez-vous votre activité ?`, 
      ...
      coord_flip() +
      labs(x = "", y = "Nombre de réponses", 
           title = "Répartition de chaque type d'activité des données selon le type d'établissement",
           caption = "Top 5 des catégories les plus représentées",
           subtitle = paste(sum(table$V1), "réponses")) +
      scale_x_discrete(labels = function(x) stringr::str_wrap(x, width = 40)) + 
      theme_classic() +
...
table |> 
    mutate(keep = case_when(`Dans quel type d'établissement exercez-vous votre activité ?` == "Organisme de recherche" &
                                row_number() >= 10 ~ 1, .default = 0)) |> ungroup() |> 
    filter(any(keep == 1), .by = rowname) |> select(-keep) |> 
    mutate(rowname = str_replace_all(rowname, "Choisir", "Choisir l'entrepôt"),
...
formation_cycle_plus |> 
    ggplot(aes(y = V1)) + 
      ...
      labs(x = "Besoins de formation", y = "Nombre de réponses", 
           title = "Répartition des besoins de formation selon l'intervention dans le cycle de vie de la donnée",
           caption = "Top 5 des catégories les plus représentées",
...
table |> mutate(keep = case_when(cat == "Personnel d'appui / soutien à la recherche" & row_number() <= 6 ~ 1, .default = 0)) |>  
    filter(any(keep == 1), .by = rowname) |> select(-keep) |> 
    mutate(rowname = fct_reorder(rowname, V1)) |> 
    ggplot(aes(x = rowname, y = V1, fill = cat, group = cat)) +
      geom_bar(stat = "identity", width = .6) +
      coord_flip() +
      labs(x = "", y = "Nombre de réponses", 
           title = "Répartition des besoins de formation selon la catégorie d'emploi",
           caption = "Top 5 des catégories les plus représentées",
           subtitle = paste(sum(table$V1), "réponses")) +
      scale_x_discrete(labels = function(x) stringr::str_wrap(x, width = 40)) + 
      theme_classic() +
...
formation_besoins_plus |> 
    ggplot(aes(y = V1)) + 
      geom_col(aes(x = formation), color = "white", fill = "#169B62", width = 0.7) +
      labs(x = "Besoins de formation", y = "Nombre de réponses", 
           title = "Répartition des besoins de formation selon le type de formation à la \ngestion des données de recherche",
           caption = "Top 5 des catégories les plus représentées",
