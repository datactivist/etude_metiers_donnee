...
table |> 
    ...
    #'#e2c44d','#5f4496', "#ffe725", "#169B62", "#5770BE"
...
formation_activites |> 
    ...
    mutate(rowname = str_replace_all(rowname, c("Structurer les données et les outils pour la collecte, le stockage et le traitement" = "Structurer les données et les outils pour la \ncollecte, le stockage et le traitement",
                                                "Décrire et mettre en œuvre le protocole d’obtention des données initiales – brutes" = "Décrire et mettre en œuvre le protocole \nd’obtention des données brutes",
                                                "Nettoyer, affiner, convertir et décrire les données brutes" = "Nettoyer, affiner, convertir et décrire les \ndonnées brutes",
                                                "Coordonner les activités de gestion et diffusion des données" = "Coordonner les activités de gestion et \ndiffusion des données")),
    ...
    ggplot(aes(y = V1)) + 
     #text = paste("Besoin de formation :", formation, "\nTravail des données :", rowname, "\n", V1, "réponses soit", percent, "%"))) +
      ...
      labs(x = "Besoins de formation", y = "Nombre de réponses", title = "Besoins de formation selon l'activité du travail des données",
      ...
      theme(legend.position = "none", 
            ...
            plot.title = element_text(face = "bold", hjust = 1, size = 17),
            plot.subtitle = element_text(face = "italic", size = 15),
            strip.text.x = element_text(face = "bold"),
...
croisements_domaine(96, 110, 6) |> 
    ...
    ggplot(aes(y = V1)) + 
      ...
      labs(x = "Domaine thématique", y = "Nombre de réponses", title = "Domaine thématique selon les besoins de formation",
...
croisements_domaine(81, 84, 4) |> 
    ...
    ggplot(aes(y = V1)) + 
      geom_col(aes(x = domaine), color = "white", fill = "#5770BE", width = 0.7) +
      labs(x = "Domaine thématique", y = "Nombre de réponses", title = "Domaine thématique selon la formation en gestion de données",
               subtitle = paste0(sum(formation_activites$V1), " réponses")) +
      theme_classic() +
      scale_x_discrete(labels = function(x) stringr::str_wrap(x, width = 50)) + #axis-text trop longs sur plusieurs lignes
      coord_flip() +
...
croisements_domaine(16, 22, 7) |> 
    ...
    ggplot(aes(y = V1)) + 
      geom_col(aes(x = domaine), color = "white", fill = "#5770BE", width = 0.7) +
      labs(x = "Domaine thématique", y = "Nombre de réponses", title = "Domaine thématique selon l'intervention dans le cycle de vie de la donnée",
               subtitle = paste0(sum(formation_activites$V1), " réponses")) +
      theme_classic() +
      scale_x_discrete(labels = function(x) stringr::str_wrap(x, width = 50)) + #axis-text trop longs sur plusieurs lignes
      coord_flip() +
...
croisements_domaine(23, 37, 6) |> 
    ...
    ggplot(aes(y = V1)) + 
      geom_col(aes(x = domaine), color = "white", fill = "#5770BE", width = 0.7) +
      labs(x = "Domaine thématique", y = "Nombre de réponses", title = "Domaine thématique selon l'activité dans les données",
            caption = "Top 6 des catégories les plus représentées",
               subtitle = paste0(sum(formation_activites$V1), " réponses")) +
      theme_classic() +
      scale_x_discrete(labels = function(x) stringr::str_wrap(x, width = 50)) + #axis-text trop longs sur plusieurs lignes
...
croisements_domaine(66, 76, 6) |> 
    ...
    ggplot(aes(y = V1)) + 
      geom_col(aes(x = domaine), color = "white", fill = "#5770BE", width = 0.7) +
      labs(x = "Domaine thématique", y = "Nombre de réponses", title = "Domaine thématique selon le type de données travaillé",
            caption = "Top 6 des catégories les plus représentées",
               subtitle = paste0(sum(formation_activites$V1), " réponses")) +
      theme_classic() +
      scale_x_discrete(labels = function(x) stringr::str_wrap(x, width = 50)) + #axis-text trop longs sur plusieurs lignes
...
table <- data |> 
    ...
    mutate(rowname = str_extract(rowname, "(?<=\\[).*"),
           rowname = substr(rowname, 1, nchar(rowname)-1),
           rowname = str_extract(rowname, "^[^(]+"), 
           `Dans quel type d'établissement exercez-vous votre activité ?` = str_extract(`Dans quel type d'établissement exercez-vous votre activité ?`, "^[^(]+")) |> 
    arrange(desc(V1)) 
table_plus <- table |> 
...
formation_cycle_plus <- rbind(analyser, maj, coordonner, structurer, protocole_obtention, deposer, standards, qualite, nettoyer, publier, outils, superviser, metadonnees, entrepot) |> 
    group_by(rowname) |> 
    arrange(desc(V1)) |> 
...
formation_cycle_plus |> 
    ggplot(aes(y = V1)) + 
      ...
      labs(x = "Besoins de formation", y = "Nombre de réponses", 
           title = "Besoins de formation selon l'intervention dans le cycle de vie de la donnée",
           caption = "Top 5 des catégories les plus représentées",
           subtitle = paste0(sum(formation_cycle_plus$V1), " réponses")) +
      theme_classic() +
      scale_x_discrete(labels = function(x) stringr::str_wrap(x, width = 50)) + #axis-text trop longs sur plusieurs lignes
      coord_flip() +
      theme(legend.position = "none", 
            ...
            plot.title = element_text(face = "bold", size = 17, hjust = 1),
            plot.subtitle = element_text(face = "italic", size = 15),
            strip.text.x = element_text(face = "bold"),
            axis.title.y = element_text(margin = margin(t = 0, r = 25, b = 0, l = 0)),
            panel.grid.major.x = element_line(size = 0.5)) +
...
formation_cycle_moins <- rbind(analyser, maj, coordonner, structurer, protocole_obtention, deposer, standards, qualite, nettoyer, publier, outils, superviser, metadonnees, entrepot) |> 
    group_by(rowname) |> 
    arrange(desc(V1)) |> 
    ...
    mutate(rowname = fct_reorder(rowname, V1),
           rowname = factor(rowname, levels = c("Collecte, création, stockage",
                                            ...
                                            "Ouverture ou partage ",
                                            "Réutilisation",
                                            "Planification, plan de gestion de données")))
...
formation_cycle_moins |> 
    ggplot(aes(y = V1)) + 
      ...
      labs(x = "Besoins de formation", y = "Nombre de réponses", 
           title = "Besoins de formation selon l'intervention dans le cycle de vie de la donnée",
           caption = "Top 5 des catégories les moins représentées",
           subtitle = paste0(sum(formation_cycle_moins$V1), " réponses")) +
      theme_classic() +
      scale_x_discrete(labels = function(x) stringr::str_wrap(x, width = 50)) + #axis-text trop longs sur plusieurs lignes
      coord_flip() +
      theme(legend.position = "none", 
...
formation_besoins_plus <- rbind(analyser, maj, coordonner, structurer, protocole_obtention, deposer, standards, qualite, nettoyer, publier, outils, superviser, metadonnees, entrepot) |> 
    group_by(rowname) |> 
    arrange(desc(V1)) |> 
    ...
    mutate(rowname = str_replace_all(rowname, c("Formation intra- ou inter-établissement" = "Formation intra- ou \ninter-établissement")),
...
formation_besoins_plus |> 
    ggplot(aes(y = V1)) + 
      geom_col(aes(x = formation), color = "white", fill = "#169B62", width = 0.7) +
      labs(x = "Besoins de formation", y = "Nombre de réponses", 
           title = "Besoins de formation selon la formation à la gestion \net diffusion des données de recherche",
           caption = "Top 5 des catégories les plus représentées",
           subtitle = paste0(sum(formation_besoins_plus$V1), " réponses")) +
      theme_classic() +
      scale_x_discrete(labels = function(x) stringr::str_wrap(x, width = 50)) + #axis-text trop longs sur plusieurs lignes
      coord_flip() +
      theme(legend.position = "none", 
...
formation_besoins_moins <- rbind(analyser, maj, coordonner, structurer, protocole_obtention, deposer, standards, qualite, nettoyer, publier, outils, superviser, metadonnees, entrepot) |> 
    group_by(rowname) |> 
    arrange(desc(V1)) |> 
    mutate(keep = case_when(rowname == "Autoformation" & row_number() >= 10 ~ 1, .default = 0)) |> ungroup() |> 
    filter(any(keep == 1), .by = formation) |> select(-keep) |> 
    mutate(rowname = fct_reorder(rowname, V1),
           rowname = str_replace_all(rowname, c("Formation intra- ou inter-établissement" = "Formation intra- ou \ninter-établissement")))
...
formation_besoins_moins |> 
    ggplot(aes(y = V1)) + 
      ...
      labs(x = "Besoins de formation", y = "Nombre de réponses", 
           title = "Besoins de formation selon la formation à la gestion \net diffusion des données de recherche",
           caption = "Top 5 des catégories les moins représentées",
           subtitle = paste0(sum(formation_besoins_moins$V1), " réponses")) +
      theme_classic() +
      scale_x_discrete(labels = function(x) stringr::str_wrap(x, width = 50)) + #axis-text trop longs sur plusieurs lignes
      coord_flip() +
      theme(legend.position = "none", 
