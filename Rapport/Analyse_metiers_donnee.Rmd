...
cycle_lieux |> 
  ...
  # geom_text(aes(y = V1 + 2, x = cycle, label = paste(percent, "%", sep = "")), 
  #           color = "#333333", size = 3, check_overlap = T) +
  labs(x = "Cycle de vie de la donnée", y = "Nombre de réponses", title = "Lieux d'activités selon l'intervention dans le cycle de vie de la donnée",
