...
# Données
data <- read_csv("../data/donnees_complete.csv") |> 
...
`r nrow(data)` répondant(e)s, 28 questions

```{r}
print(dfSummary(data, style = "grid", graph.magnif = 1, 
          ...
          labs(title = titre,
             tag = figure, 
               subtitle = paste0(data |> filter(!is.na({{variable}})) |> nrow(), " réponses, soit ", 
                                round(((data |> filter(!is.na({{variable}})) |> nrow()) / nrow(data)) * 100, 0), "% des répondant(e)s")) +
          xlim(c(0, 4)) +   
          theme_void() +
...
barplot_qs_unique <- function(data, variable, titre, figure){
    data |> 
        ...
        ggplot(aes(x = col, y = n)) +
          ...
          coord_flip() +
          labs(x = "", y = "Nombre de répondant(e)s", title = titre,
             tag = figure, 
               subtitle = paste0(data |> filter(!is.na({{variable}})) |> nrow(), " réponses, soit ", 
                                round(((data |> filter(!is.na({{variable}})) |> nrow()) / nrow(data)) * 100, 0), "% des répondant(e)s")) +
          scale_x_discrete(labels = function(x) stringr::str_wrap(x, width = 40)) + 
          ...
          labs(x = "", y = "Nombre de répondant(e)s", title = titre,
             tag = figure, 
               subtitle = paste0(data |> filter(!is.na(`Quelle est votre catégorie d'emploi actuel ?`)) |> nrow(), " réponses, soit ", 
                                round(((data |> filter(!is.na(`Quelle est votre catégorie d'emploi actuel ?`)) |> nrow()) / nrow(data)) * 100, 0), "% des répondant(e)s")) +
          scale_x_discrete(labels = function(x) stringr::str_wrap(x, width = 40)) + 
...
graph
saving_plot(graph, "2", 7, 6)

graph <- wordcloud_autre(data, `Dans quel type d'établissement exercez-vous votre activité ? [Autre]`, "Dans quel type d'établissement exercez-vous votre activité ? \n[Autre]", 40, 10, "Fig. 3")
graph
saving_plot(graph, "3", 7, 6)

graph <- barplot_qs_multiples(data, 8, 12, 1, 11, "#5770BE", "Où réalisez-vous votre activité en lien avec les données de \nrecherche ?", "Fig. 4")  
graph
saving_plot(graph, "4", 7, 6)

graph <- barplot_qs_unique(data, `Sur quel domaine thématique réalisez-vous votre activité sur les données ?`, "Sur quel domaine thématique réalisez-vous votre activité sur \nles données ?", "Fig. 5")
graph
saving_plot(graph, "5", 7, 6)

graph <- barplot_cycle(data, "Fig. 6")
graph
saving_plot(graph, "6", 7, 6)
```
...
plot_moins <- data |> 
    ...
    theme(plot.caption = element_text(face = "italic"))
graph <- grid.arrange(plot_plus, plot_moins, ncol = 2, top = textGrob("Quelles sont les activités qu'implique votre travail sur les données ?",gp=gpar(fontsize = 15, font = 2)))
graph
saving_plot(graph, "7", 12, 8)
...
plot_moins <- data |> 
    ...
    labs(caption = "Top 5 des catégories les moins représentées") +
    theme(plot.caption = element_text(face = "italic"))
graph <- grid.arrange(plot_plus, plot_moins, ncol = 2, top = textGrob("Comment intervenez-vous sur ces activités ?", gp = gpar(fontsize = 15, font = 2)))
graph
saving_plot(graph, "8", 12, 8)
...
plot_moins <- data |> 
    ...
    labs(caption = "Top 5 des catégories les moins représentées") +
    theme(plot.caption = element_text(face = "italic"))
graph <- grid.arrange(plot_plus, plot_moins, ncol = 2, top = textGrob("Quel est le poids de chaque activité dans votre travail ?",gp=gpar(fontsize = 15, font = 2)))
graph
saving_plot(graph, "9", 12, 8)
```

```{r out.width='60%'}

graph <- barplot_qs_multiples(data, 66, 76, 1, 11, "#5770BE", "Sur quels types de données travaillez-vous ?", "Fig. 10")
graph
saving_plot(graph, "10", 7, 6)

graph <- wordcloud_autre(data, `Sur quels types de données travaillez-vous ? [Autre]`, "Sur quels types de données travaillez-vous ? [Autre]", 40, 12, "Fig. 11")
graph
saving_plot(graph, "11", 7, 6)

graph <- barplot_qs_unique(data, `Quel est votre niveau de diplôme ?`, "Quel est votre niveau de diplôme ?", "Fig. 12")  
graph
saving_plot(graph, "12", 7, 6)
...
graph
saving_plot(graph, "13", 7, 6)

graph <- barplot_qs_unique(data, `Quel est le domaine de votre formation initiale ?`, "Une variété de domaines de formation initiale", "Fig. 14")  
graph
saving_plot(graph, "14", 7, 6)

graph <- wordcloud_autre(data, `Quel est le domaine de votre formation initiale ? [Autre]`, "Quel est le domaine de votre formation initiale ? [Autre]", 40, 10, "Fig. 15")
graph
saving_plot(graph, "15", 7, 6)

graph <- barplot_qs_multiples(data, 81, 84, 1, 11, "#5770BE", "Vous êtes-vous formé à la gestion et la diffusion des \ndonnées de recherche ?", "Fig. 16")
graph
saving_plot(graph, "16", 7, 6)

graph <- barplot_qs_unique_top_n(data, `Quels postes, fonctions ou responsabilités significatifs avez-vous occupés dans l'enseignement supérieur et/ou la recherche, du plus récent au plus ancien ? [Intitulé du poste le plus récent]`, 1, 10, "Quels postes, fonctions ou responsabilités significatifs avez-vous \noccupés dans l'enseignement supérieur et/ou la recherche, \ndu plus récent au plus ancien ?", "Fig. 17") +
    labs(subtitle = "Top 10 des plus récents (t)")
graph
saving_plot(graph, "17", 7, 6)

graph <- barplot_qs_unique_top_n(data, `Quels postes, fonctions ou responsabilités significatifs avez-vous occupés dans l'enseignement supérieur et/ou la recherche, du plus récent au plus ancien ? [Intitulé du poste précédent]`, 1, 10, "Quels postes, fonctions ou responsabilités significatifs avez-vous \noccupés dans l'enseignement supérieur et/ou la recherche, \ndu plus récent au plus ancien ?", "Fig. 18") +
    labs(subtitle = "Top 10 des postes précédents (t-1)")
graph
saving_plot(graph, "18", 7, 6)

graph <- barplot_qs_unique_top_n(data, `Quels postes, fonctions ou responsabilités significatifs avez-vous occupés dans l'enseignement supérieur et/ou la recherche, du plus récent au plus ancien ? [Intitulé du poste précédent] 2`, 1, 10, "Quels postes, fonctions ou responsabilités significatifs avez-vous \noccupés dans l'enseignement supérieur et/ou la recherche, \ndu plus récent au plus ancien ?", "Fig. 19") +
    labs(subtitle = "Top 10 des postes précédents (t-2)")
graph
saving_plot(graph, "29", 7, 6)

graph <- barplot_qs_unique_top_n(data, `Quels postes, fonctions ou responsabilités significatifs avez-vous occupés dans l'enseignement supérieur et/ou la recherche, du plus récent au plus ancien ? [Intitulé du poste précédent] 3`, 1, 10, "Quels postes, fonctions ou responsabilités significatifs avez-vous \noccupés dans l'enseignement supérieur et/ou la recherche, \ndu plus récent au plus ancien ?", "Fig. 20") +
    labs(subtitle = "Top 10 des postes précédents (t-3)")
graph
saving_plot(graph, "20", 7, 6)

graph <- barplot_qs_unique_top_n(data, `Quels postes, fonctions ou responsabilités significatifs avez-vous occupés dans l'enseignement supérieur et/ou la recherche, du plus récent au plus ancien ? [Intitulé du poste précédent] 4`, 1, 10, "Quels postes, fonctions ou responsabilités significatifs avez-vous \noccupés dans l'enseignement supérieur et/ou la recherche, \ndu plus récent au plus ancien ?", "Fig. 21") +
    labs(subtitle = "Top 10 des postes précédents (t-4)")
graph
saving_plot(graph, "21", 7, 6)
```
...
donut <- data |> 
    ...
    mutate(`Quelle est votre catégorie d'emploi actuel ?` = str_extract(`Quelle est votre catégorie d'emploi actuel ?`, "^[^(]+"),
           `Quelle est votre catégorie d'emploi actuel ?` = str_replace_all(`Quelle est votre catégorie d'emploi actuel ?`, 
                                         "Chercheur / Enseignant-chercheur", "Chercheur(se)s / enseignant(e)s-chercheur(se)s")) |> 
...
saving_plot(donut, "22.1", 6, 5)

bar <- barplot_branche_activite_emploi(data, "Branche d'activité des répondant(e)s", "Fig. 22.2")+
    theme(plot.title = element_text(hjust = 1))
saving_plot(bar, "22.2", 7, 5)
...
```{r out.width='60%'}
graph <- wordcloud_autre(data, `Précisez votre branche d'activité. [Autre]`, "Précisez votre branche d'activité. [Autre]", 40, 10, "Fig. 24")
graph
saving_plot(graph, "24", 7, 6)

graph <- wordcloud_autre(data, `Dans le cadre de votre activité sur les données, sur quels réseaux ou communautés vous appuyez-vous ?`, "Dans le cadre de votre activité sur les données, \nsur quels réseaux ou communautés vous appuyez-vous ?", 40, 10, "Fig. 25")  
graph
saving_plot(graph, "25", 7, 6)
```
...
plot_moins <- barplot_qs_multiples(data, 96, 110, 11, 15, "#ffe725", "", "") +
    labs(caption = "Top 5 des catégories les moins représentées") +
    theme(plot.caption = element_text(face = "italic"))
graph <- grid.arrange(plot_plus, plot_moins, ncol = 2, top = textGrob("Sur quelles activités auriez-vous besoin d'une formation ?", gp = gpar(fontsize = 15, font = 2)))
graph
saving_plot(graph, "26", 15, 8)
```

```{r out.width='60%'}
graph <- wordcloud_autre(data, `Sur quelles activités auriez-vous besoin d'une formation ? [Autre]`, "Sur quelles activités auriez-vous besoin d'une formation ? [Autre]", 10, 13, "Fig. 27")
graph
saving_plot(graph, "27", 7, 6)

graph <- wordcloud_autre(data, `Sous quel intitulé présentez-vous votre poste actuel ?`, "Sous quel intitulé présentez-vous votre poste actuel ?", 40, 10, "Fig. 28")
graph
saving_plot(graph, "28", 7, 6)
...
donut <- data |> 
    ...
    theme(legend.position = "bottom") +
    guides(fill = guide_legend(title = "", nrow = 2, byrow = T))
saving_plot(donut, "38.1", 6, 5)
bar <- data |> 
    filter(is_volunteer == 1) |>
    barplot_branche_activite_emploi("Branche d'activité des répondant(e)s", "Fig. 38.2") +
    labs(subtitle = "Répartition des 452 volontaires aux entretiens") +
    theme(plot.subtitle = element_text(hjust = 1),
          plot.title = element_text(hjust = 1))
saving_plot(bar, "38.2", 6, 5)
grid.arrange(donut, bar, ncol = 2)
      ...
      ggplot(aes(x = col, y = n, fill = is_cycle, group = is_cycle))+
        ...
        labs(x = "", y = "Nombre de répondant(e)s", title = titre, 
             ...
             subtitle = paste0(sum(table$n), " réponses, soit ", 
                             round(((sum(table$n)) / nrow(data)) * 100, 0), "% des répondant(e)s")) +
        theme_classic() +
        scale_x_discrete(labels = function(x) stringr::str_wrap(x, width = 40)) + 
...
graph <- barplot_comp_cycle(data, `Sur quelle(s) partie(s) du cycle de vie des données intervenez-vous ? [Analyse, traitement, calcul]`, "Analyse, traitement, calcul", "Autres parties du cycle", `Sur quel domaine thématique réalisez-vous votre activité sur les données ?`, "Discipline des répondant(e)s intervenant sur \nla partie 'Analyse, traitement, calcul' du cycle de \nvie de la donnée", "Fig. 42")
graph
saving_plot(graph, "42", 8, 7)

graph <- barplot_comp_cycle(data, `Sur quelle(s) partie(s) du cycle de vie des données intervenez-vous ? [Analyse, traitement, calcul]`, "Analyse, traitement, calcul", "Autres parties du cycle", `Précisez votre branche d'activité.`, "Branche d'activité des répondant(e)s intervenant \nsur la partie 'Analyse, traitement, calcul' du \ncycle de vie de la donnée", "Fig. 43")
graph
saving_plot(graph, "43", 8, 7)
...
graph <- data |> 
    ...
    labs(caption = paste(data |> filter(`Sur quelle(s) partie(s) du cycle de vie des données intervenez-vous ? [Analyse, traitement, calcul]` == "Oui" & `Sur quelle(s) partie(s) du cycle de vie des données intervenez-vous ? [Collecte, création, stockage]` == "Non" & `Sur quelle(s) partie(s) du cycle de vie des données intervenez-vous ? [Dépôt]` == "Non" & `Sur quelle(s) partie(s) du cycle de vie des données intervenez-vous ? [Ouverture ou partage (accès restreint)]` == "Non" & `Sur quelle(s) partie(s) du cycle de vie des données intervenez-vous ? [Planification, plan de gestion de données]` == "Non" & `Sur quelle(s) partie(s) du cycle de vie des données intervenez-vous ? [Préparation du dépôt (structuration et description)]` == "Non" & `Sur quelle(s) partie(s) du cycle de vie des données intervenez-vous ? [Réutilisation]` == "Non") |> nrow(), 
                         "répondant(e)s n'interviennent que sur la partie 'Analyse, traitement, calcul'")) +
    theme(plot.caption = element_text(face = 'italic'))
graph
saving_plot(graph, "44", 8, 7)
```

#### Collecte, création, stockage

```{r out.width='60%'}
graph <- barplot_comp_cycle(data, `Sur quelle(s) partie(s) du cycle de vie des données intervenez-vous ? [Collecte, création, stockage]`, "Collecte, création, stockage", "Autres parties du cycle", `Sur quel domaine thématique réalisez-vous votre activité sur les données ?`, "Discipline des répondant(e)s intervenant sur \nla partie 'Collecte, création, stockage' du cycle de \nvie de la donnée", "Fig. 45")
graph
saving_plot(graph, "45", 8, 7)

graph <- barplot_comp_cycle(data, `Sur quelle(s) partie(s) du cycle de vie des données intervenez-vous ? [Collecte, création, stockage]`, "Collecte, création, stockage", "Autres parties du cycle", `Précisez votre branche d'activité.`, "Branche d'activité des répondant(e)s intervenant \nsur la partie 'Collecte, création, stockage' du \ncycle de vie de la donnée", "Fig. 46")
graph
saving_plot(graph, "46", 8, 7)
...
graph <- data |> 
    ...
    labs(caption = paste(data |> filter(`Sur quelle(s) partie(s) du cycle de vie des données intervenez-vous ? [Analyse, traitement, calcul]` == "Non" & `Sur quelle(s) partie(s) du cycle de vie des données intervenez-vous ? [Collecte, création, stockage]` == "Oui" & `Sur quelle(s) partie(s) du cycle de vie des données intervenez-vous ? [Dépôt]` == "Non" & `Sur quelle(s) partie(s) du cycle de vie des données intervenez-vous ? [Ouverture ou partage (accès restreint)]` == "Non" & `Sur quelle(s) partie(s) du cycle de vie des données intervenez-vous ? [Planification, plan de gestion de données]` == "Non" & `Sur quelle(s) partie(s) du cycle de vie des données intervenez-vous ? [Préparation du dépôt (structuration et description)]` == "Non" & `Sur quelle(s) partie(s) du cycle de vie des données intervenez-vous ? [Réutilisation]` == "Non") |> nrow(), 
                         "répondant(e)s n'interviennent que sur la partie 'Collecte, création, stockage'")) +
    theme(plot.caption = element_text(face = 'italic'))
graph
saving_plot(graph, "47", 8, 7)
```
...
graph <- table |> 
    ggplot(aes(x = rowname, y  = percent, fill = `Quelle est votre catégorie d'emploi actuel ?`, group = `Quelle est votre catégorie d'emploi actuel ?`)) +
      ...
      labs(x = "", y = "Pourcentage",  tag = "Fig. 49",
           title = "Répartition de l'intervention dans le cycle de vie de la données selon la catégorie d'emploi des répondant(e)s",
           subtitle = paste(sum(table$V1), "réponses")) +
      scale_x_discrete(labels = function(x) stringr::str_wrap(x, width = 40)) + 
      theme_classic() +
      theme(legend.position = "none",
    ...
    ggplot(aes(y  = percent)) + 
     #text = paste("Besoin de formation :", formation, "\nTravail des données :", rowname, "\n", V1, "réponses soit", percent, "%"))) +
      ...
      labs(x = "Besoins de formation", y = "Pourcentage",  tag = "Fig. 51",
           title = "Répartition des besoins de formation des répondant(e)s selon leur type d'activités dédiées aux données",
...
graph
saving_plot(graph, "51", 12, 10)
```

-   6% des répondant(e)s ayant une activité dans le choix de l'entrepôt ont un besoin de formation en '*supervision de l'ensemble du cycle de vie*'.
...
graph <- table |> 
    ...
    ggplot(aes(x = rowname, y  = percent, fill = `Quelle est votre catégorie d'emploi actuel ?`, group = `Quelle est votre catégorie d'emploi actuel ?`)) +
      ...
      labs(x = "", y = "Pourcentage",  tag = "Fig. 52",
           title = "Répartition de chaque type d'activité dédiée aux données selon la catégorie d'emploi des répondant(e)s",
      ...
      geom_text(aes(y  = percent + 0.13*max(percent), x = rowname, label = paste(percent, "%", sep = "")), 
                color = "#333333", size = 3, check_overlap = T) +
      geom_text(aes(y  = .25, x = rowname, label = paste(V1, "répondant(e)s")), 
                color = "#CCCCCC", size = 5, check_overlap = T, hjust = 0) +
      scale_fill_manual(values = c(c("#ffe725", "#5770BE")))
graph
saving_plot(graph, "52", 12, 8)
```
...
graph <- table |> 
    ...
    ggplot(aes(x = rowname, y  = percent, fill = `Quelle est votre catégorie d'emploi actuel ?`, group = `Quelle est votre catégorie d'emploi actuel ?`)) +
      ...
      labs(x = "", y = "Pourcentage",  tag = "Fig. 53",
           title = "Répartition de chaque type d'activité dédiée aux données \nselon la catégorie d'emploi des répondant(e)s",
      ...
      geom_text(aes(y  = percent + 0.13*max(percent), x = rowname, label = paste(percent, "%", sep = "")), 
                color = "#333333", size = 3, check_overlap = T) +
      geom_text(aes(y  = .25, x = rowname, label = paste(V1, "répondant(e)s")), 
                color = "#CCCCCC", size = 3, check_overlap = T, hjust = 0) +
      facet_wrap(~`Quelle est votre catégorie d'emploi actuel ?`) +
      scale_fill_manual(values = c(c("#ffe725", "#5770BE")))
graph
saving_plot(graph, "53", 10, 6)
```
...
graph <- croisements_domaine(96, 110, 6) |> 
    ...
    ggplot(aes(y  = percent)) + 
      ...
      labs(x = "Discipline", y = "Pourcentage",  tag = "Fig. 54",
           title = "Répartition des besoins de formation par discipline des répondant(e)s",
      ...
      facet_wrap(~rowname, labeller = labeller(facet_category = label_wrap_gen(width = 5)))
graph
saving_plot(graph, "54", 10, 7)
```

-   21% des répondant(e)s ayant un besoin de formation en '*analyse, représentation, modélisation et prédiction*' travaillent dans la discipline des sciences humaines et sociales.

##### Formation gestion de données

```{r prop4.2, fig.width=12, fig.height=8}
# Domaine thématique / Formation gestion de données
graph <- croisements_domaine(81, 84, 4) |> 
    mutate(rowname = str_wrap(rowname, width = 55)) |> 
    mutate(domaine = reorder(domaine, V1, desc = TRUE)) |> 
    ggplot(aes(y  = percent)) + 
      geom_col(aes(x = domaine), color = "white", fill = "#5770BE", width = 0.7) +
      labs(x = "Discipline", y = "Pourcentage",  tag = "Fig. 55",
           title = "Répartition des types de formation en gestion de données par discipline des répondant(e)s",
           subtitle = paste0(sum(formation_activites$V1), " réponses")) +
      theme_classic() +
      scale_x_discrete(labels = function(x) stringr::str_wrap(x, width = 55)) + #axis-text trop longs sur plusieurs lignes
      coord_flip() +
      ...
      facet_wrap(~rowname, labeller = labeller(facet_category = label_wrap_gen(width = 5)))
graph
saving_plot(graph, "55", 10, 7)
```

-   21% des répondant(e)s s'étant *autoformés* à la gestion et la diffusion de données travaillent dans la discipline des sciences humaines et sociales.

##### Cycle de vie

```{r prop4.3, fig.width=12, fig.height=8}
# Domaine thématique / Cycle de vie
graph <- croisements_domaine(16, 22, 7) |> 
    mutate(rowname = str_wrap(rowname, width = 55)) |> 
    mutate(domaine = reorder(domaine, V1, desc = TRUE)) |> 
    ggplot(aes(y  = percent)) + 
      geom_col(aes(x = domaine), color = "white", fill = "#5770BE", width = 0.7) +
      labs(x = "Discipline", y = "Pourcentage",  tag = "Fig. 56",
           title = "Répartition de l'intervention dans le cycle de vie de la donnée par discipline des répondant(e)s",
           subtitle = paste0(sum(formation_activites$V1), " réponses")) +
      theme_classic() +
      scale_x_discrete(labels = function(x) stringr::str_wrap(x, width = 55)) + #axis-text trop longs sur plusieurs lignes
      coord_flip() +
      ...
      facet_wrap(~rowname, labeller = labeller(facet_category = label_wrap_gen(width = 5)))
graph
saving_plot(graph, "56", 10, 7)
```

-   17% des répondant(e)s intervenant en *analyse, traitement et calcul* dans le cycle de vie travaillent dans la discipline des sciences humaines et sociales.

##### Activités des données

```{r prop4.4, fig.width=12, fig.height=8}
# Domaine thématique / Activités des données
graph <- croisements_domaine(23, 37, 6) |> 
    mutate(rowname = str_wrap(rowname, width = 55)) |> 
    mutate(domaine = reorder(domaine, V1, desc = TRUE)) |> 
    ggplot(aes(y  = percent)) + 
      geom_col(aes(x = domaine), color = "white", fill = "#5770BE", width = 0.7) +
      labs(x = "Discipline", y = "Pourcentage", tag = "Fig. 57",
           title = "Répartition du type d'activité dans les données par discipline des répondant(e)s",
           caption = "Top 6 des catégories les plus représentées",
           subtitle = paste0(sum(formation_activites$V1), " réponses")) +
      theme_classic() +
      scale_x_discrete(labels = function(x) stringr::str_wrap(x, width = 55)) + #axis-text trop longs sur plusieurs lignes
      ...
      facet_wrap(~rowname, labeller = labeller(facet_category = label_wrap_gen(width = 5)))
graph
saving_plot(graph, "57", 10, 7)
```

-   17% des répondant(e)s travaillant en *analyse, traitement et calcul* sur les données travaillent dans la discipline des sciences humaines et sociales.

##### Types de données

```{r prop4.5, fig.width=12, fig.height=8}
# Domaine thématique / Types de données
graph <- croisements_domaine(66, 76, 6) |> 
    mutate(rowname = str_wrap(rowname, width = 55)) |> 
    mutate(domaine = reorder(domaine, V1, desc = TRUE)) |> 
    ggplot(aes(y  = percent)) + 
      geom_col(aes(x = domaine), color = "white", fill = "#5770BE", width = 0.7) +
      labs(x = "Discipline", y = "Pourcentage",  tag = "Fig. 58",
           title = "Répartition du type de données travaillé par discipline des répondant(e)s",
           caption = "Top 6 des catégories les plus représentées",
           subtitle = paste0(sum(formation_activites$V1), " réponses")) +
      theme_classic() +
      scale_x_discrete(labels = function(x) stringr::str_wrap(x, width = 55)) + #axis-text trop longs sur plusieurs lignes
      ...
      facet_wrap(~rowname, labeller = labeller(facet_category = label_wrap_gen(width = 5)))
graph
saving_plot(graph, "58", 10, 7)
```

-   34% des répondant(e)s travaillant des *données d'enquête et statistiques* travaillent dans la discipline des sciences humaines et sociales.
...
graph <- formation_cycle_plus |> 
    ggplot(aes(y  = percent)) + 
      geom_col(aes(x = formation), color = "white", fill = "#169B62", width = 0.7) +
      labs(x = "Besoins de formation", y = "Pourcentage",  tag = "Fig. 61",
           title = "Un besoin transverse de formation sur les enjeux de qualité \ndes données et de leur conformité aux cadres législatifs",
           caption = "Top 5 des catégories les plus représentées",
      ...
      facet_wrap(~rowname, labeller = labeller(facet_category = label_wrap_gen(width = 5)))
graph
saving_plot(graph, "61", 12,10)
#saving_plot(graph, "61", 10, 8)
#ggsave(file = glue("Graphiques/PNG/Figure_61.png"), plot = graph, width = 10, height = 8)
```

-   9% des répondant(e)s intervenant en *collecte, création et stockage* dans le cycle de vie ont un besoin de formation en '*supervision de l'ensemble du cycle de vie*'.
...
graph <- formation_cycle_moins |> 
    ggplot(aes(y  = percent)) + 
      ...
      facet_wrap(~rowname, labeller = labeller(facet_category = label_wrap_gen(width = 5)))
graph
saving_plot(graph, "62", 12,10)
```

-   6% des répondant(e)s intervenant en *collecte, création et stockage* dans le cycle de vie ont un besoin de formation en '*nettoyage, affinement, conversion et description des données brutes*'.
...
graph <- table |> mutate(keep = case_when(cat == "Personnel d'appui / soutien à la recherche" & row_number() <= 6 ~ 1, .default = 0)) |>  
    filter(any(keep == 1), .by = rowname) |> select(-keep) |> 
    mutate(rowname = fct_reorder(rowname, V1)) |> 
    ggplot(aes(x = rowname, y  = percent, fill = cat, group = cat)) +
      ...
      labs(x = "", y = "Pourcentage",  tag = "Fig. 63",
           title = "Répartition des besoins de formation des répondant(e)s selon leur catégorie d'emploi",
           caption = "Top 5 des catégories les plus représentées",
           subtitle = paste(sum(table$V1), "réponses")) +
      scale_x_discrete(labels = function(x) stringr::str_wrap(x, width = 40)) + 
      theme_classic() +
...
graph <- formation_besoins_plus |> 
    ggplot(aes(y  = percent)) + 
      ...
      facet_wrap(~rowname, labeller = labeller(facet_category = label_wrap_gen(width = 5)))
graph
saving_plot(graph, "65", 12, 9)
```

-   12% des répondant(e)s s'étant *autoformés* à la gestion et la diffusion de données ont un besoin de formation pour '*garantir la qualité des données et leur conformité de diffusion par rapport aux cadres législatifs*'.
...
graph <- formation_besoins_moins |> 
    ggplot(aes(y  = percent)) + 
      ...
      facet_wrap(~rowname, labeller = labeller(facet_category = label_wrap_gen(width = 5)))
graph
saving_plot(graph, "66", 12, 9)
```

-   6% des répondant(e)s s'étant *autoformés* à la gestion et la diffusion de données ont un besoin de formation en '*création, structuration, description des jeux de données validés*'.
...
graph <- liste_entretiens |> 
    ...
    labs(subtitle = "Répartition des 27 volontaires interrogés en entretien")  
graph
saving_plot(graph, "68", 7, 6)

graph <- liste_entretiens |> 
    barplot_qs_unique(`Sur quel domaine thématique réalisez-vous votre activité sur les données ?`, "Sur quel domaine thématique réalisez-vous votre activité sur \nles données ?", "Fig. 69") +
    labs(subtitle = "Répartition des 27 volontaires interrogés en entretien")
graph
saving_plot(graph, "69", 7, 6)

graph <- liste_entretiens |> 
    barplot_cycle("Fig. 70") +
    labs(subtitle = "Répartition des 27 volontaires interrogés en entretien")
graph
saving_plot(graph, "70", 7, 6)
```
...
graph <- liste_entretiens |> 
    ...
    labs(subtitle = "Répartition des 27 volontaires interrogés en entretien")
graph
saving_plot(graph, "72", 8, 6)

graph <- liste_entretiens |> 
    barplot_qs_multiples(81, 84, 1, 11, "#5770BE", "Vous êtes-vous formé à la gestion et la diffusion des \ndonnées de recherche ?", "Fig. 73") +
    labs(subtitle = "Répartition des 27 volontaires interrogés en entretien")
graph
saving_plot(graph, "73", 8, 6)
```
...
donut <- liste_entretiens |> 
    ...
    theme(legend.position = "bottom") +
    guides(fill = guide_legend(title = "", nrow = 2, byrow = T))
saving_plot(donut, "74.1", 8, 6)
bar <- liste_entretiens |> 
    barplot_branche_activite_emploi("Branche d'activité des répondant(e)s", "Fig. 74.2") +
    labs(subtitle = "Répartition des 27 volontaires interrogés en entretien") +
    theme(plot.subtitle = element_text(hjust = 1),
          plot.title = element_text(hjust = 1))
saving_plot(bar, "74.2", 8, 6)
grid.arrange(donut, bar, ncol = 2)
...
graph <- table |> 
    ggplot(aes(x = rowname, y = V1)) +
      ...
      geom_text(aes(y = V1 + 0.13*max(V1), x = rowname, label = paste(percent, "%", sep = "")), 
                color = "#333333", size = 5, check_overlap = T)
graph
saving_plot(graph, "4_retravaille", 7, 5)
```
...
ggplot(aes(x = rowname, y = V1)) +
  ...
  geom_text(aes(y = V1 + 0.13*max(V1), x = rowname, label = paste(percent, "%", sep = "")), 
        color = "#333333", size = 5, check_overlap = T) 
graph
saving_plot(graph, "6_retravaille", 7, 5)
```
...
graph <- table |> 
    ggplot(aes(x = rowname, y = V1)) +
      ...
      geom_text(aes(y = V1 + 0.13*max(V1), x = rowname, label = paste(percent, "%", sep = "")), 
                color = "#333333", size = 5, check_overlap = T)
graph
saving_plot(graph, "16_retravaille", 7, 5)
```
...
graph
saving_plot(graph, "25_retravaille", 7, 5)
```
...
graph <- data |> 
    ...
    ggplot(aes(ymax = ymax, ymin = ymin, xmax = 3.3, xmin = 2, fill = `Votre établissement/organisme a-t-il formalisé une organisation des activités ou des rôles sur les données à l'échelle de l'établissement ou de différentes structures ?`)) +
      ...
      coord_polar(theta="y") +
      labs(title = stringr::str_wrap("Politique des données dans les établissements / organismes, 57% des répondant(e)s déclarent que leur structure a formalisé un document de gouvernance", width = 45),
           tag = "Fig. 29", 
      ...
      guides(fill = guide_legend(title = ""))
graph
saving_plot(graph, "29_retravaille", 7, 5)
```
...
graph
saving_plot(graph, "matrice_generale_retravaille", 15, 8)
```
...
graph
saving_plot(graph, "48_retravaille", 12, 9)
```
...
graph
saving_plot(graph, "50_A_retravaille", 8, 8)
```
...
graph <- table |> 
    ggplot(aes(x = col, y = n)) +
      ...
      coord_flip() +
      labs(x = "", y = "Nombre de répondant(e)s",  tag = "Fig. 12",
       title = stringr::str_wrap("9/10 des répondant(e)s ont un niveau BAC+5 ou plus", width = 55),
      ...
      geom_text(aes(y = n + 0.1*max(n), x = col, label = paste(percent, "%", sep = "")), 
                color = "#333333", size = 3, check_overlap = T)
graph
saving_plot(graph, "12_retravaille", 7, 5)
```
...
graph <- table |> 
    ggplot(aes(x = col, y = n)) +
      ...
      coord_flip() +
      labs(x = "", y = "Nombre de répondant(e)s",  tag = "Fig. 23.1",
...
graph
saving_plot(graph, "23.1_retravaille", 7, 5)
```
...
graph <- table |> 
    ggplot(aes(x = col, y = n)) +
      ...
      coord_flip() +
      labs(x = "", y = "Nombre de répondant(e)s",  tag = "Fig. 23.2",
       title = stringr::str_wrap("45% des répondant(e)s de la catégorie des chercheur(se)s et enseignant(e)s-chercheur(se)s sont MCU ou CR", width = 55),
      ...
      geom_text(aes(y = n + 0.13*max(n), x = col, label = paste(percent, "%", sep = "")), 
                color = "#333333", size = 3, check_overlap = T)
graph
saving_plot(graph, "23.2_retravaille", 7, 5)
```
...
saving_plot(graph, "26_retravaille", 12, 7)
```

```{r fig 26 sans num figure, fig.width = 12, fig.height=7}
plot_plus <- barplot_qs_multiples2(data, 96, 110, 1, 5, "#169B62", "", "", 
                      "Top 5 des besoins de formation", NA) +
    ylim(0, 650) +
...
plot_moins <- barplot_qs_multiples2(data, 96, 110, 11, 15, "#ffe725", "", "", 
                      "Bottom 5 des besoins de formation", NA) +
    theme(plot.tag = element_blank(),
          plot.title = element_blank(),
          plot.subtitle = element_blank())
...
graph <- grid.arrange(plot_plus, plot_moins, ncol = 2, 
             ...
             bottom = textGrob("Question posée dans le questionnaire : Sur quelles activités auriez-vous besoin d'une formation ?", 
                            gp = gpar(fontsize = 11, font = 3)))
saving_plot(graph, "26_retravaille_sans_num_figure", 12, 7)
```
...
graph <- table |> 
  ggplot(aes(x = col, y = n, fill = is_cycle, group = is_cycle))+
    ...
    coord_flip() +
    labs(x = "", y = "Nombre de répondant(e)s", tag = "Fig. 42", 
...
graph
saving_plot(graph, "42_retravaille", 8, 7)
```
...
graph <- table |> 
  ggplot(aes(x = col, y = n, fill = is_cycle, group = is_cycle))+
    geom_bar(stat="identity", position = "dodge", width=.9, col = "white", size = .5) +
    coord_flip() +
    labs(x = "", y = "Nombre de répondant(e)s", tag = "Fig. 43", 
...
graph
saving_plot(graph, "43_retravaille", 7, 6)
```
...
graph <- table |> 
  ...
  ggplot()+
    ...
    coord_flip() +
    labs(x = "", y = "Nombre de répondant(e)s", tag = "Fig. 45", 
         title = stringr::str_wrap("Quatre disciplines concentrent 52% des répondant(e)s impliquées dans la collecte, la création, le stockage", width = 55),
         caption = stringr::str_wrap(paste0("Question posée dans le questionnaire : Sur quel domaine thématique réalisez-vous votre activité sur les données ? - ", sum(table$n), " réponses"), width = 65)) + 
    theme_classic() +
    custom_theme() +
    ylim(0, 260) +
    ...
    geom_bar(aes(x = col, y = barre_grise, group = is_cycle), fill = "#666666",
             stat="identity", position = "dodge", width=.9, col = "white", size = .5) 
graph
saving_plot(graph, "45_retravaille", 8, 7)
```
...
graph <- table |> 
  ggplot(aes(x = col, y = n, fill = is_cycle, group = is_cycle))+
    geom_bar(stat="identity", position = "dodge", width=.9, col = "white", size = .5) +
    coord_flip() +
    labs(x = "", y = "Nombre de répondant(e)s", tag = "Fig. 46", 
    ...
    geom_text(aes(y = n + 9, x = col, label = paste(round(percent,0), "%", sep="")), 
              ...
              position = position_dodge(width = .9))
graph
saving_plot(graph, "46_retravaille", 10, 7)
```
    ...
    ggplot(aes(x = domaine, y = part, group = group, fill = group, alpha = domaine != "Plusieurs/tous les domaines")) +
      ...
      labs(x = "", y = "Pourcentage des enseignants-chercheurs\net chercheurs", tag = "Fig. 5.1", 
         ...
         subtitle = stringr::str_wrap("Comparaison de la répartition des enseignants-chercheurs et <br>chercheurs dans les 
                                      disciplines à <span style='color: #cbcbcb;'>l'échelle nationale</span> et parmi <br><span style='color: #5770BE;'>les répondant(e)s</span>", width = 55),
...
#subtitle : Comparaison de la répartition des enseignants-chercheurs dans les <br>disciplines à <span style='color: #cbcbcb;'>l'échelle nationale</span> et parmi <span style='color: #5770BE;'>les répondant(e)s</span>
saving_plot(graph, "5.1_retravaille", 8, 7)
```
...
graph <- data |>
    ...
    ggplot(aes(x = col, y = percent, group = `Quelle est votre catégorie d'emploi actuel ?`, 
      ...
      coord_flip() +
      labs(x = "", y = "Pourcentage des répondant(e)s", tag = "Fig. 5.2", 
         title = stringr::str_wrap("Des personnels d'appui / soutiens à la recherche pluridisciplinaires", width = 55),
         subtitle = stringr::str_wrap("Répartition des <span style='color: #5770BE;'>personnel d'appui / soutien à la recherche</span> et <br><span style='color: #ffe725;'>chercheur(se)s / enseignant(e)s-chercheur(se)s</span> dans les disciplines", width = 55),
      ...
      theme(legend.position = "none",
            ...
            panel.grid.major.y = ggplot2::element_blank())
graph
saving_plot(graph, "5.2_retravaille", 8, 8.5)
```
...
graph <- table |> 
    ggplot(aes(x = rowname, y = V1)) +
      ...
      labs(x = "", y = "Nombre de réponses", tag = "Fig. 10.1", 
           title = stringr::str_wrap("Données avec lesquelles les répondant(e)s travaillent", width = 55),
         subtitle = stringr::str_wrap("", width = 55),
         caption = stringr::str_wrap(paste0("Question posée dans le questionnaire : Sur quels types de données travaillez-vous ? - ", sum(table$V1), " réponses pour 1565 répondant(e)s"), width = 65)) +
      scale_x_discrete(labels = function(x) stringr::str_wrap(x, width = 40)) + 
      theme_classic() +
      ylim(0, 1300) +
      custom_theme() +
      ...
      geom_text(aes(y = V1 + 0.07*max(V1), x = rowname, hjust = 0, label = paste(percent, "%", sep = "")), 
                color = "#333333", size = 5, check_overlap = T)
graph
saving_plot(graph, "10.1_retravaille", 8, 5)
```
...
graph <- domaine_donnees |> 
  ...
  labs(x = "", y = "Pourcentage des réponses", tag = "Fig. 10.2",
       title = "Les données d'observation utilisées par au moins 10% des répondant(e)s dans les 4 familles \nde disciplines", 
       subtitle = "Part de données utilisées dans le travail des répondant(e)s selon leur discipline regroupée en 4 grandes familles",
...
graph
saving_plot(graph, "10.2_retravaille", 13, 10)
```
...
mat1 <- ggcorrplot(matrix_chercheurs, hc.order = T, type = "lower", show.diag = TRUE, legend.title = "",
    ...
    labs(title = stringr::str_wrap("Chercheurs / Enseignants-chercheurs", width = 55), 
         ...
         caption = stringr::str_wrap("Question posée dans le questionnaire : Sur quelle(s) partie(s) du cycle de vie des données intervenez-vous ? - 710 répondant(e)s", width = 65)) +
    theme(axis.text.y = element_blank(),
          panel.grid = element_blank(),
...
mat2 <- ggcorrplot(matrix_personnel, hc.order = T, type = "lower", show.diag = TRUE, legend.title = "",
    ...
    labs(title = stringr::str_wrap("Personnels d'appui / soutiens à la recherche", width = 55), 
         ...
         caption = stringr::str_wrap("Question posée dans le questionnaire : Sur quelle(s) partie(s) du cycle de vie des données intervenez-vous ? - 855 répondant(e)s", width = 65)) +
    theme(axis.text.y = element_blank(),
          panel.grid = element_blank(),
...
graph <- table |> 
    ggplot(aes(x = rowname, y  = percent, fill = `Quelle est votre catégorie d'emploi actuel ?`, group = `Quelle est votre catégorie d'emploi actuel ?`)) +
      ...
      labs(x = "", y = "Pourcentage de réponses",  tag = "Fig. 50",
           title = stringr::str_wrap("Les <span style='color: #ffe725;'>chercheur(se)s / enseignant(e)s-chercheur(se)s</span> <br>davantage dans l'analyse \nque les <span style='color: #5770BE;'>personnels <br>d'appui / soutien à la recherche</span>", width = 55), 
         subtitle = stringr::str_wrap("Répartition de l'intervention dans le cycle de vie de la données selon la catégorie d'emploi des répondant(e)s", width = 55),
      ...
      guides(fill = guide_legend(title = "", nrow = 2, reverse = TRUE))
graph
saving_plot(graph, "50_B_retravaille", 7, 6)
```
...
graph <- data |> 
    ...
    ggplot(aes(x = col, y = n, fill = col), fill = "#5770BE") +
      geom_bar(stat = "identity", width = .6) +
      coord_flip() +
      labs(x = "", y = "Nombre de répondant(e)s", tag = "Fig. 22.2", 
      ...
      guides(fill = guide_legend(title = "", nrow = 2, byrow = TRUE))
graph
saving_plot(graph, "22.2_retravaille", 7, 6)
```


```{r}
graph <- wordcloud_autre(data, `Précisez votre branche d'activité. [Autre]`, "Précisez votre branche d'activité. [Autre]", 30, 10, "Fig. 24") +
    labs(title = stringr::str_wrap("La biologie, l'instrumentation et les archives sont les principales branche d'activité déclarées parmi les répondant(e)s exerçant des fonctions supports", width = 55),
    ...
    custom_theme()
graph
saving_plot(graph, "24_retravaille", 7, 5)
```
...
p1 <- table |> ungroup() |> 
    ...
    ggplot(aes(x = rowname, y  = percent)) +
      geom_bar(stat = "identity", width = .6, fill = "#ffe725") +
      coord_flip() +
      labs(x = "", y = "Pourcentage des répondant(e)s",  tag = "Fig. 52.1",
           #title = "Répartition des activités dédiées aux données selon la catégorie d'emploi des répondant(e)s",
           subtitle = "Chercheur(se) / Enseignant(e)-chercheur(se)",
...
p2 <- table |> ungroup() |> 
    ...
    ggplot(aes(x = rowname, y  = percent)) +
      geom_bar(stat = "identity", width = .6, fill = "#5770BE") +
      coord_flip() +
      labs(x = "", y = "Pourcentage des répondant(e)s", 
...
#plot_grid(p1, p2, align = 'vh', nrow = 1, label_y = 1, rel_heights = c(.65,.35), 
 #         labels = "Répartition des activités dédiées aux données selon la catégorie d'emploi des répondant(e)s")
graph <- grid.arrange(p1, p2, nrow = 1, 
             top = grid::textGrob("Répartition des activités les plus courantes selon la catégorie d'emploi des répondant(e)s", 
                                  gp = grid::gpar(fontsize = 18, font = 2)), 
...
saving_plot(graph, "52.1_retravaille", 15, 7)
```
...
shs <- table |> ungroup() |> 
    ...
    ggplot(aes(x = rowname, y  = percent)) +
      geom_bar(stat = "identity", width = .6, fill = "#5770BE") +
      coord_flip() +
      labs(x = "", y = "Pourcentage des répondant(e)s",  tag = "Fig. 52.2",
           #title = "Répartition des activités dédiées aux données selon la catégorie d'emploi des répondant(e)s",
...
graph <- grid.arrange(test, ncol = 1, 
             top = grid::textGrob("Répartition des activités les plus courantes selon la branche d'activité des répondant(e)s", 
...
saving_plot(graph, "52.2_retravaille", 15, 15)
```
...
labo <- data |>
    ...
    ggplot(aes(x = rowname, y  = percent)) +
      geom_bar(stat = "identity", width = .6, fill = "#5770BE") +
      coord_flip() +
      labs(x = "", y = "Pourcentage des répondant(e)s", tag = "Fig. 52.3",
...
graph <- grid.arrange(test, ncol = 1, 
             top = grid::textGrob("Répartition des activités les plus courantes selon le lieu d'activité des répondant(e)s", 
                                  gp = grid::gpar(fontsize = 20, font = 2, fontfamily = font, col = "#222222")), 
             bottom = grid::textGrob("Questions posées dans le questionnaire : Quelles sont les activités qu'implique votre travail sur les données ?, \nOù réalisez-vous votre activité en lien avec les données de recherche ?", 
                                  gp = grid::gpar(fontsize = 18, font = 3, col = "#cbcbcb", fontfamily = font)))

saving_plot(graph, "52.3_retravaille", 15, 15)
```
...
p1 <- table |> ungroup() |> 
    ...
    ggplot(aes(x = rowname, y  = percent)) +
      geom_bar(stat = "identity", width = .6, fill = "#ffe725") +
      coord_flip() +
      labs(x = "", y = "Pourcentage des répondant(e)s",  tag = "Fig. 53.1",
           #title = "Répartition des activités dédiées aux données selon la catégorie d'emploi des répondant(e)s",
           subtitle = "Chercheur(se) / Enseignant(e)-chercheur(se)",
...
#plot_grid(p1, p2, align = 'vh', nrow = 1, label_y = 1, rel_heights = c(.65,.35), 
 #         labels = "Répartition des activités dédiées aux données selon la catégorie d'emploi des répondant(e)s")
graph <- grid.arrange(p1, p2, nrow = 1, 
             top = grid::textGrob("Répartition des activités les moins courantes selon la catégorie d'emploi des répondant(e)s", 
                                  gp = grid::gpar(fontsize = 18, font = 2)), 
             bottom = grid::textGrob("Questions posées dans le questionnaire : Quelles sont les activités qu'implique votre travail sur les données ?, \nQuelle est votre catégorie d'emploi actuel ?", 
                                  gp = grid::gpar(fontsize = 18, font = 3, col = "#cbcbcb", fontfamily = font)))
saving_plot(graph, "53.1_retravaille", 15, 7)
```
...
shs <- table |> ungroup() |> 
    ...
    ggplot(aes(x = rowname, y  = percent)) +
      geom_bar(stat = "identity", width = .6, fill = "#5770BE") +
      coord_flip() +
      labs(x = "", y = "Pourcentage des répondant(e)s",  tag = "Fig. 53.2",
           #title = "Répartition des activités dédiées aux données selon la catégorie d'emploi des répondant(e)s",
           subtitle = "Sciences humaines et sociales",
...
test <- plot_grid(shs, biblio, edition, info, gestion, autre, ncol = 2, align = 'vh')
graph <- grid.arrange(test, ncol = 1, 
             top = grid::textGrob("Répartition des activités les moins courantes selon la branche d'activité des répondant(e)s", 
                                  gp = grid::gpar(fontsize = 20, font = 2, fontfamily = font, col = "#222222")), 
             bottom = grid::textGrob("Question posée dans le questionnaire : Quelles sont les activités qu'implique votre travail sur les données ?, \nPrécisez votre branche d'activité.", 
                                  gp = grid::gpar(fontsize = 18, font = 3, col = "#cbcbcb", fontfamily = font, hjust = 1)))
saving_plot(graph, "53.2_retravaille", 15, 15)
```
...
labo <- data |>
    ...
    ggplot(aes(x = rowname, y  = percent)) +
      geom_bar(stat = "identity", width = .6, fill = "#5770BE") +
      coord_flip() +
      labs(x = "", y = "Pourcentage des répondant(e)s", tag = "Fig. 53.3",
           subtitle = "Laboratoire / unité / équipe de recherche",
...
test <- plot_grid(labo, infra, central, decon, dir, ncol = 2, align = 'vh')
graph <- grid.arrange(test, ncol = 1, 
             top = grid::textGrob("Répartition des activités les moins courantes selon le lieu d'activité des répondant(e)s", 
                                  gp = grid::gpar(fontsize = 20, font = 2, fontfamily = font, col = "#222222")), 
             bottom = grid::textGrob("Questions posées dans le questionnaire : Quelles sont les activités qu'implique votre travail sur les données ?, \nOù réalisez-vous votre activité en lien avec les données de recherche ?", 
                                  gp = grid::gpar(fontsize = 18, font = 3, col = "#cbcbcb", fontfamily = font)))

saving_plot(graph, "53.3_retravaille", 15, 15)
```
...
graph <- table |> 
    ...
    ggplot(aes(x = rowname, y  = percent, fill = `Dans quel type d'établissement exercez-vous votre activité ?`, 
      ...
      geom_bar(stat = "identity", width = .6) +
      coord_flip() +
      labs(x = "", y = "Pourcentage de répondant(e)s",  tag = "Fig. 59",
           title = "Répartition des activités les plus courantes selon le type d'établissement d'affiliation des répondant(e)s",
...
graph
saving_plot(graph, "59_retravaille", 15, 10)
```
...
graph <- table |> 
    ...
    ggplot(aes(x = rowname, y  = percent, fill = `Dans quel type d'établissement exercez-vous votre activité ?`, 
      ...
      geom_bar(stat = "identity", width = .6) +
      coord_flip() +
      labs(x = "", y = "Pourcentage de répondant(e)s",  tag = "Fig. 60",
           title = "Répartition des activités les moins courantes selon le type d'établissement d'affiliation des répondant(e)s",
      ...
      scale_fill_manual(values = c("Ecole \n(5% des établissements)" = "#ffe725", 
                                   ...
                                   "Autre \n(4% des établissements)" = "#666666"))
graph
saving_plot(graph, "60_retravaille", 15, 10)
```
...
graph <- table |> 
    ...
    ggplot(aes(x = rowname, y  = percent, fill = cat, group = cat)) +
      geom_bar(stat = "identity", width = .6) +
      coord_flip() +
      labs(x = "", y = "Pourcentage des répondant(e)s",  tag = "Fig. 63",
           title = "Répartition des besoins de formation les plus courants selon la catégorie d'emploi des répondant(e)s",
      ...
      scale_fill_manual(values = c(c("#ffe725", "#5770BE")))
graph
saving_plot(graph, "63_retravaille", 15, 10)
```
...
graph <- table |> 
    ...
    ggplot(aes(x = rowname, y  = percent, fill = cat, group = cat)) +
      geom_bar(stat = "identity", width = .6) +
      coord_flip() +
      labs(x = "", y = "Pourcentage des répondant(e)s",  tag = "Fig. 64",
           title = "Répartition des besoins de formation les moins courants selon la catégorie d'emploi des répondant(e)s",
      ...
      scale_fill_manual(values = c(c("#ffe725", "#5770BE")))
graph
saving_plot(graph, "64_retravaille", 15, 8)
```
...
fviz_mca_ind(res.mca,
             label = "none", # masquer le texte des répondant(e)s
